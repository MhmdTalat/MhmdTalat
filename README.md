...
## 📄 CV – Muhammed Tallat Hassan Ahmed

**Back End Developer**  
Nasr City, Cairo, Egypt  
📧 [muhammedtallat4@gmail.com](mailto:muhammedtallat4@gmail.com)  
📞 +201028182637  
[LinkedIn](https://www.linkedin.com/in/muhammed-tallat-a440881b7) | [GitHub](https://github.com/MhmdTalat)
...
- **Bachelor of Science (B.Sc) in Computing and Information**  
  Arab Academy for Science, Technology and Maritime Transport (Graduated: 2022)
...
- **CCNA7 Introduction to Networks**  
  ...
  *July – August 2021*  
  Enterprise Networking, Security, Automation; Switching, Routing, and Wireless Essentials  
  **Score:** 88%

- **Certificate of Contribution**  
  2nd International Mobile, Intelligent, and Ubiquitous Computing Conference (MIUCC-22), Misr International University  
  *May 8-9, 2022* – Paper: Deepfake Video Detection (IEEE Egypt Section)
...
- **.NET Technologies:** ADO.NET, LINQ, Entity Framework, ASP.NET Web Forms, MVC, Web API, .NET Core, Postman, REST API testing, SDLC, Azure
- **Web Technologies:** HTML5, CSS3, Bootstrap, jQuery, JavaScript
- **Other Skills:** Microservices, OOP, Data Structures & Algorithms, GitHub

---

**🔬 Projects**

- **Deep Fake Media Detection (Graduation Project)**
  - **Grade:** Excellent (A)
  - **Duration:** Sept 2021 – July 2022
  - Developed mobile & web platform to detect deep fake content (ASP.NET, Flutter)
  - Created CRNN algorithms for manipulation detection, AUROC: 89.36
  - Research Publication: IEEE Xplore

- **E-Commerce API**
  - **Tech:** ASP.NET Core, Entity Framework Core, SQL Server, JWT, Swagger
  - JWT authentication, secure architecture, cart/product/category management

- **E-commerce Site (Food marts Code First)**
  - Tech: SQL, MVC, C#, JavaScript, Bootstrap, Entity Framework Core
  - Features: JWT authentication, order tracking, smart cart & Wishlist, admin dashboard

- **E-commerce Site (Pharmacy Store DB First)**
  - Tech: Oracle, MVC, C#, JavaScript, Bootstrap, Entity Framework Core
  - Features: JWT authentication, order tracking, smart cart & Wishlist, admin dashboard
...
- Deepfake Video Detection – IEEE MIUCC 2022
- Data Science & AI Fundamentals – IBM
